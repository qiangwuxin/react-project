...
export const usePagesStore = create((set, get) => ({
  cards: [
    ...
    },
    {
      ...
      height: 300,
      url: 'https://ts1.tc.mm.bing.net/th/id/R-C.178a8c54d6947bc52f597b54d9995653?rik=eiVfSwTzYyOb1Q&riu=http%3a%2f%2fimgs.bzw315.com%2fUploadFiles%2fimage%2f2016%2f11%2f22%2f201611220940447192.jpg&ehk=m%2faQS9FFkwk2PQeNClfi6SK3yYFzQc6uYSFVmuUeR5U%3d&risl=&pid=ImgRaw&r=0',
    },
    {
      id: 1 - 7,
      title: '全麦面包',
  ...
  fetchMore: async () => {
    ...
    console.log('fetchMore 被調用，當前頁面:', get().page);
    set({ loading: true });
    ...
    try {
      ...
      try {
        ...
        console.log("API失敗，使用模擬數據");
        // 生成模擬數據
        const mockCards = [
          {
            id: `mock-${get().page}-1`,
            title: `模擬商品 ${get().page}-1`,
